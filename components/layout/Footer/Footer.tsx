...
const Footer = () => (
	<footer className='bg-blue-50'>
		...
		<div
			className='flex py-7 flex-col items-center border-t-2 border-solid border-gray-300 px-8 md:px-32 lg:px-44 md:items-start md:justify-between md:flex-row'>
